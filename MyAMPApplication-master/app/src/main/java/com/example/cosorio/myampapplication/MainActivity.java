...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textSize = (SeekBar) findViewById(R.id.seekBar1);
        second = (SeekBar) findViewById(R.id.seekBar2);
        textToGrow = (TextView) findViewById(R.id.editText);
        rate = (RatingBar) findViewById(R.id.ratingBar);
        rate.setMax(FiveStars);

        textSize.setOnSeekBarChangeListener(new SeekBar. int progress. boolean fromUser);
    }
